...
SwaggerUi.Views.ParameterView = Backbone.View.extend({
                                                         ...
                                                         render: function () {
                                                             ...
                                                             this.model.paramType =
                                                                 this.model.in || this.model.paramType;
                                                             this.model.isBody =
                                                                 this.model.paramType === 'body' || this.model.in
                                                                 === 'body';
                                                             ...
                                                             this.model.hasDefault =
                                                                 (typeof this.model.default !== 'undefined');
                                                             ...
                                                             var isJSON = isXML ? this.contains(consumes, 'json')
                                                                 : true;
                                                             sampleJSON =
                                                                 SwaggerUi.partials.signature.createParameterJSONSample(
                                                                     modelType, modelDefinitions);
                                                             ...
                                                             if (this.options.swaggerOptions.jsonEditor
                                                                 && this.model.isBody && this.model.schema) {
                                                                 var $self = $(this.el);
                                                                 ...
                                                                 // This is so that the signature can send back the
                                                                 // sample to the json editor TODO: SignatureView
                                                                 // should expose an event "onSampleClicked" instead
                                                             ...
                                                             if (isParam) {
                                                                 ...
                                                                 $('.parameter-content-type', $(this.el))
                                                                     .append(parameterContentTypeView.render().el);
                                                         ...
                                                         toggleParameterSnippet: function () {
                                                             var contentType = this.$('[name=parameterContentType]')
                                                                 .val();
                                                         ...
                                                         // Return an appropriate template based on if the parameter is
                                                         // a list, readonly, required
                                                         template: function () {
