...
SwaggerUi.Views.MainView = Backbone.View.extend({
                                                    ...
                                                    initialize: function (opts) {
                                                        ...
                                                        if (opts.swaggerOptions.operationsSorter) {
                                                            ...
                                                            if (_.isFunction(sorterFn)) {
                                                                for (key in this.model.apisArray) {
                                                                    this.model.apisArray[key].operationsArray.sort(
                                                                        sorterFn);
                                                                }
                                                            }
                                                        }
                                                        ...
                                                        // JSonEditor requires type='object' to be present on defined
                                                        // types, we add it if it's missing is there any valid case
                                                        // were it should not be added ?
                                                        var def;
                                                    ...
                                                    addResource: function (resource, auths) {
                                                        ...
                                                        resource.id =
                                                            resource.id.replace(/[^a-zA-Z\d]/g, function (str) {
                                                                return str.charCodeAt(0);
                                                            });

                                                        // Make all definitions available at the root of the resource
                                                        // so that they can be loaded by the JSonEditor
