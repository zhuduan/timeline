...
SwaggerUi.Views.AuthButtonView = Backbone.View.extend({
                                                          ...
                                                          initialize: function (opts) {
                                                              ...
                                                              this.auths =
                                                                  this.options.data.oauth2.concat(
                                                                      this.options.data.auths);
                                                          },

                                                          render: function () {
                                                              var tplName = this.isOperation ? 'authBtnOperation'
                                                                  : 'authBtn';
                                                          ...
                                                          authorizeBtnClick: function (e) {
                                                              ...
                                                              // The content of the popup is removed and all events
                                                              // unbound after clicking the 'Cancel' button of the
                                                              // popup. We'll have to re-render the contents before
                                                              // creating a new popup view.
                                                              this.render();

                                                              this.popup =
                                                                  new SwaggerUi.Views.PopupView({model: authsModel});
                                                              this.popup.render();
                                                          },
                                                          ...
                                                          renderAuths: function (auths) {
                                                              ...
                                                              auths.forEach(function (auth) {
                                                                  var authView = new SwaggerUi.Views.AuthView(
                                                                      {data: auth, router: this.router});
