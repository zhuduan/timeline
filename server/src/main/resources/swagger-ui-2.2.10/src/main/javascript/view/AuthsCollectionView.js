...
SwaggerUi.Views.AuthsCollectionView = Backbone.View.extend({
                                                               ...
                                                               initialize: function (opts) {
                                                                   ...
                                                                   this.collection =
                                                                       new SwaggerUi.Collections.AuthsCollection(
                                                                           opts.data);
                                                               ...
                                                               render: function () {
                                                                   ...
                                                                   this.$el.html(
                                                                       this.$innerEl.html() ? this.$innerEl : '');
                                                               ...
                                                               renderOneAuth: function (authModel) {
                                                                   ...
                                                                   } else if (type === 'basic' && this.$innerEl.find(
                                                                           '.basic_auth_container').length === 0) {
                                                                   ...
                                                                   if (authViewName) {
                                                                       authView =
                                                                           new SwaggerUi.Views[authViewName](
                                                                               {model: authModel, router: this.router});
